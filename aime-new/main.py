...
parser.add_argument('--w-dim', type=int, default=3, metavar='w', help='dimension of w')
parser.add_argument('--hidden-size', type=int, default=3, metavar='H', help='Hidden size')
