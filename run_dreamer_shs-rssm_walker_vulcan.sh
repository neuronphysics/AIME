...
#SBATCH --output=/home/memole/scratch/AIME/logs/dreamer_shs_walker_%A_%a.out
#SBATCH --error=/home/memole/scratch/AIME/logs/dreamer_shs_walker_%A_%a.err
