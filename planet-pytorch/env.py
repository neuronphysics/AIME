...
GYM_ENVS = ['Pendulum-v0', 'MountainCarContinuous-v0', 'CarRacing-v0', 'CartPoleContinuousBulletEnv-v0', 'Ant-v2', 'HalfCheetah-v2', 'Hopper-v2', 'Humanoid-v2', 'HumanoidStandup-v2', 'InvertedDoublePendulum-v2', 'InvertedPendulum-v2', 'Reacher-v2', 'Swimmer-v2', 'Walker2DBulletEnv-v0']
