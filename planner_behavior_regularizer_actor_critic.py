...
if not os.path.exists('/home/memole/TEST/offlinerl/data'):
  os.makedirs('/home/memole/TEST/offlinerl/data')
#FLAGS = flags.FLAGS
#app.flags.DEFINE_string('f', '', 'kernel')
import argparse
parser = argparse.ArgumentParser(description='BRAC')
parser.add_argument('--root_offlinerl_dir', type=dir_path, default='/home/memole/TEST/offlinerl/data', help='Root directory for saving data')
...
def collect_gym_data(args):
    ...
    args.policy_root_dir = os.path.join(args.test_srcdir,
                                               data_dir)
    args.n_samples = 1000000  # Short collection.
