...
parser.add_argument('--w-dim', type=int, default=150, metavar='w', help='dimension of w')
parser.add_argument('--hidden-size', type=int, default=500, metavar='H', help='Hidden size')
parser.add_argument('--state-size', type=int, default=200, metavar='Z', help='State/latent size')
