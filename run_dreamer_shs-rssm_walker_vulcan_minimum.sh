...
#SBATCH --output=/home/memole/scratch/AIME/logs/dreamerv3-shs-rssm-walker_%A_%a.out
#SBATCH --error=/home/memole/scratch/AIME/logs/dreamerv3-shs-rssm-walker_%A_%a.err
...
echo "Walker:    seed=${SEED} steps=${STEPS} batch=${BATCH_SIZE}x${BATCH_LENGTH}"
...
suite.load("walker", "walk").physics.render(64, 64)
