...
dreamerv2_average_steps = (dreamerv2_steps_seed_1[:num_dreamerv2samples] + dreamerv2_steps_seed_2[:num_dreamerv2samples] + dreamerv2_steps_seed_3[:num_dreamerv2samples])/3
...
slac_average_return = (slac_returns_seed_1[:num_slac_samples] + slac_returns_seed_2[:num_slac_samples] + slac_returns_seed_3[:num_slac_samples]) / 3
slac_average_steps = (slac_steps_seed_1[:num_slac_samples] + slac_steps_seed_2[:num_slac_samples] + slac_steps_seed_3[:num_slac_samples]) / 3
...
regular_vae_average_steps = (regular_vae_steps_seed1[:num_regular_vae_samples] + regular_vae_steps_seed2[:num_regular_vae_samples] + regular_vae_steps_seed3[:num_regular_vae_samples])/3
...
'''
plt.plot(dreamerv2_average_steps, dreamerv2_average_eval_return, label="Dreamerv2")
plt.plot(slac_average_steps, slac_average_return, label="Slac")
#plt.plot(planet_steps_seed1[:num_planet_samples], planet_average_eval_return, label="Planet")
#plt.plot(regular_vae_average_steps, regular_vae_average_eval_return, label="D2E (Regular VAE)")
