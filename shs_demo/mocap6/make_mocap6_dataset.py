# Provenance script, kept as documentation of how dataset.npz was made:
# M. Hughes' original mocap6 -> npz conversion.  Runs under Python 2 with
# bnpy against the upstream mocap6dataset .mat (note xrange and the
# author-machine path below); dataset.npz in this folder is its output.
import pandas as pd
import numpy as np
import scipy.io
import bnpy
