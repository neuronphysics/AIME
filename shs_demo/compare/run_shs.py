...
DEFAULTS = dict(
    fhn=dict(K0=8, kappa=0.0, alpha=0.5, gamma=10.0, start_alpha=10.0,
             laps=6, sweep_every=1, b0_mode="calibrate", sF=0.1, pca=0,
...
def main():
    ...
    ap.add_argument("--gate-input", choices=["carry", "latent"], default="carry",
                    help="gate feature: projected carry (deterministic) or latent x_{t-1}")
    args = ap.parse_args()
