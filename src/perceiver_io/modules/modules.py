...
try:
    ...
    # Fallback if fairscale not installed
    def checkpoint_wrapper(module, *args, **kwargs):
        return module
from torch import nn as nn

from .config import CausalSequenceModelConfig
from .adapter import InputAdapter, OutputAdapter, QueryProvider, RotarySupport, TrainableQueryProvider, TiedTokenOutputAdapter, TokenInputAdapterWithRotarySupport

from .position import positions, RotaryPositionEmbedding
from .utilities import init_parameters, ModuleOutput, Residual
