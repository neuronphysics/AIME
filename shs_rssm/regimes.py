...
class DiagARRegimes(nn.Module):
    ...
    @torch.no_grad()
    # Reference implementation without g-conditioning; the g-aware
    # version below is the one in use.
    def _calibrate_b0_from_data_unused(self, z, sF: float = 0.1, valid=None):
