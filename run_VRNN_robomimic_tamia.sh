...
CUDA_VISIBLE_DEVICES=0 python3 -m VRNN.robomimic_transition_dynamics_trainer --hdf5 "$HDF5S" --obs_keys agentview_image --frame_stack 1 --img_size 64 --batch_size 25 --num_workers 4 --n_epochs 200 --run_name robomimic_lift_can_square_agentview --logger tensorboard --sequence_length 20