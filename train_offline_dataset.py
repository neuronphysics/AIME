...
from planner_regularizer_debug_dataset import Flags, D2EAgent, eval_policies
import planner_regularizer_debug_dataset
...
def main(_):
    ...
    # data_file_actions = os.path.join("offlinerl","new_datasets3rand","Pendulum-v0","sac","20220814105542","20220814105542", "replay_actions.pt")
    # data_file_next_actions = os.path.join("offlinerl","new_datasets3rand","Pendulum-v0","sac","20220814105542","20220814105542", "replay_next_actions.pt")
    # data_file_states = os.path.join("offlinerl","new_datasets3rand","Pendulum-v0","sac","20220814105542","20220814105542", "replay_states.pt")
    # data_file_next_states = os.path.join("offlinerl","new_datasets3rand","Pendulum-v0","sac","20220814105542","20220814105542", "replay_next_states.pt")
    # data_file_discounts = os.path.join("offlinerl","new_datasets3rand","Pendulum-v0","sac","20220814105542","20220814105542", "replay_discounts.pt")
    ...
    train_eval_offline(
        ...
        data_file = data_file,
        agent_module=planner_regularizer_debug_dataset,
